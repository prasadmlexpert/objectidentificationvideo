...
yolo_model = ''
def get_detection_layers(img_blob):
  ...
  return yolo_model.forward(yolo_output_layer)

class_ids_list = []
boxes_list = []
confidences_list = []

def calculateConfidence(img_blob):
  obj_detection_layers = get_detection_layers(img_blob)
